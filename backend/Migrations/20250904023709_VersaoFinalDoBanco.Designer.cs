...
namespace ChatbotApiNova.Migrations
{
    ...
    [Migration("20250904023709_VersaoFinalDoBanco")]
    partial class VersaoFinalDoBanco
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChatbotApi.Models.Chamado", b =>
                {
                    ...
                    b.Property<int?>("TecnicoResponsavelIdTecnico")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("UsuarioAberturaIdUsuario")
                        .HasColumnType("integer");

                    b.HasKey("IdChamado");

                    b.HasIndex("TecnicoResponsavelIdTecnico");

                    b.HasIndex("UsuarioAberturaIdUsuario");
            ...
            modelBuilder.Entity("ChatbotApi.Models.Comentario", b =>
                {
                    ...
                    b.Property<int>("ChamadoIdChamado")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ChatbotApi.Models.Chamado", b =>
                {
                    b.HasOne("ChatbotApi.Models.Tecnico", "TecnicoResponsavel")
                        .WithMany()
                        .HasForeignKey("TecnicoResponsavelIdTecnico");

                    b.HasOne("ChatbotApi.Models.Usuario", "UsuarioAbertura")
                        .WithMany()
                        .HasForeignKey("UsuarioAberturaIdUsuario")
            ...
            modelBuilder.Entity("ChatbotApi.Models.Comentario", b =>
                {
                    b.HasOne("ChatbotApi.Models.Chamado", "Chamado")
                        ...
                        .HasForeignKey("ChamadoIdChamado")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
